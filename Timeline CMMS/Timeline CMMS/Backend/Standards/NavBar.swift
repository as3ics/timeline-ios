...
class NavBar: UIView {
    ...
    var style: NavStyle {
        set {
            ...
            case .Root:
                alpha = 1.0
                backgroundColor = ThemeManager.shared.theme.rootHeaderBackgroundColor
                leftButton.tintColor = ThemeManager.shared.theme.rootHeaderFontColor
                rightButton.tintColor = ThemeManager.shared.theme.rootHeaderFontColor
                titleLabel.textColor = ThemeManager.shared.theme.rootHeaderFontColor
                break
            case .Sub:
                alpha = 1.0
                backgroundColor = ThemeManager.shared.theme.subHeaderBackgroundColor
                leftButton.tintColor = ThemeManager.shared.theme.subHeaderFontColor
                rightButton.tintColor = ThemeManager.shared.theme.subHeaderFontColor
                titleLabel.textColor = ThemeManager.shared.theme.subHeaderFontColor
                break
            default:
                break
            }
    ...
    fileprivate static let titleWidth: CGFloat = 180.0
    ...
    fileprivate static var topInset: CGFloat! {
        return 0
        /*
        if System.shared.phoneType == .iPhoneX {
            return 32
        } else {
            return 0
        }
