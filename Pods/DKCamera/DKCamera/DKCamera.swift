...
open class DKCamera: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    open func setupUI() {
        ...
        let bottomViewHeight: CGFloat = 70 + self.view.safeAreaInsets.bottom
        ...
        bottomViewContainer.frame = CGRect(x: 0, y: contentView.bounds.height - (bottomView.bounds.height + self.view.safeAreaInsets.bottom), width: contentView.bounds.width, height: bottomView.bounds.height )
        bottomViewContainer.autoresizingMask = [.flexibleWidth]
        ...
        cameraSwitchButton.frame.origin = CGPoint(x: bottomView.bounds.width - cameraSwitchButton.bounds.width - 15,
                                                  y: (bottomView.bounds.height - cameraSwitchButton.bounds.height) + (cameraSwitchButton.bounds.height / 2))
        ...
        captureButton.center = CGPoint(x: bottomView.bounds.width / 2, y: cameraSwitchButton.center.y)
